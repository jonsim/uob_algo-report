...
%$\beta$ --- the learning rate, how quickly the algorithm moves its price towards its target price
%$\gamma$ --- the momentum, how quickly the algorithm changes its profit margin over time
