...
\begin{document}
\title{Analysis of Adaptive Agressiveness on the\\
...
% OWNER: Max
% - ???
The main focus of our experiments was the Adpative Aggressive trader crated by Vytelingum in 2006. The adaptive aggressive algorithm relies on the principal that you can be in
two different states. One where you trade more frequently closer to your limit
price, with a higher chance of trading but lower profit per trade. The other where you
...
The adaptive aggressive algorithm uses a target price calculated dependent upon
the state of the marget. However, before we can go into detail, we must define
...
\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/intra_buyer.pdf}
\caption{Intra buyer}
\end{figure}

\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/intra_seller.pdf}
\caption{Intra seller}
\end{figure}

\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/extra_buyer.pdf}
\caption{Extra buyer}
\end{figure}

\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/extra_seller.pdf}
...
The theta affects the degree to which changing the aggressiveness moves the
target price  away from the equilibrium. So a high value of theta means that a
relatively small change in aggressiveness will result in a large move away from
the equilibrium price. This is illustrated in Fig. %\ref{fig:theta}.

\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/intra_buyer_thetas.pdf}
...
\begin{figure} 
\centering
\includegraphics[width=\columnwidth]{graphs_and_stats/average_balance_vs_time.pdf}
